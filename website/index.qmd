...
My name is Chris and I'm a data scientist, computational biologist and bioinformatician working in London.

This webpage is my online CV but I'll occasionally add some blog posts on topics I find interesting. If anything, it's just a way for me to keep some notes that I can refer back to.
...
life = pd.DataFrame({
    ...
    'months': [(18*12)+2, 2*12, 1*12,1*12, 8, 2*8, (3*12)+4, 20, 23],
    'me': ['My life']*9
})
...
life_pivot = life.pivot_table(index='me', columns='life_stage', values='years', aggfunc='sum', observed=False)
...
* Sport (tennis, football, running, cycling, golf, rugby) 
* Painting (landscapes, animals etc)
* Non-fiction books 
